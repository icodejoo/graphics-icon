...
copyPkg(resolve(here, '../../color-fonts/woff2-wasm/pkg'), resolve(here, '../dist/woff2'), 'woff2_writer.js', 'woff2', true)
copyPkg(resolve(here, '../../color-fonts/colrv1-writer/pkg'), resolve(here, '../dist/colrv1'), 'colrv1_writer.js', 'colrv1', false)
